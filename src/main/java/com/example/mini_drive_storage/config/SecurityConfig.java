...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .authorizeHttpRequests(auth -> auth.anyRequest().authenticated()); // all request must be authenticated
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        daoAuthenticationProvider.setPasswordEncoder(org.springframework.security.crypto.password.NoOpPasswordEncoder.getInstance());
